...
CLIENT_SECRET = 'd7e6710764544ca886b95e3dfffa4216'
...
def episode_lookup():
    ...
    user_episode = input("Enter the Group Therapy episode you want to analyze (i.e., Group Therapy XXX ): ")

    # Search for the artist using Spotify API
    results = sp.search(q='album:' + user_episode, type='album', limit=1)

    # Get the artist URI from the search results
    if results['album']['items']:
