...
with open("/home/student/mycode/attemptlogin/keystone.common.wsgi") as kfile:
    ...
    for line in kfile:
        ...
        if "- - - - -] Authorization failed" in line:
            ...
            with open("/home/student/mycode/attemptlogin/output_keystone.txt","w") as output_keystone:
               print(f"The total number of failed log in attempts is {loginfail}. The attempts came from {failed_ip}", file=output_keystone)
        elif "-] Authorization failed" in line:
            loginsuccess += 1 # increasing success counter
            successful_ip = line.split(" ")[-1]
            with open("/home/student/mycode/attemptlogin/output_keystone.txt","a") as output_keystone:
               print(f"The total number of successful log in attempts is {loginsuccess}. The user logged in from {successful_ip}", file=output_keystone)
